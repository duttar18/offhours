            ...
            <Navbar>
                ...
                <Navbar.Collapse id="basic-nav">
                    <Nav className="ml-auto" >
                        <Nav.Item><Nav.Link href="/browse"><Button color="inherent">Browse</Button></Nav.Link></Nav.Item>
                        ...
                        <Nav.Item>
                            {loggedin ?
                            (<Nav.Link><Button variant='contained' disableElevation color='primary' onClick={logout}>Logout({username})</Button></Nav.Link>):
                            (<Nav.Link href="/login"><Button variant='contained' color='primary' disableElevation>Login</Button></Nav.Link>)}
                        </Nav.Item>  
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
